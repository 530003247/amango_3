...
function amango_include($param){
    $Module     = empty($param[4]) ? 'Home' : $param[4];
    $Controller = empty($param[3]) ? 'Article' : $param[3];
    return APP_PATH.$Module.'/View/'.THEME_NAME.'/'.$Controller.'/'.$param[0].C('TMPL_TEMPLATE_SUFFIX');
}
function emoji($str) {
