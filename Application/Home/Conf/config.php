...
return array(
    // 预先加载的标签库
    'TAGLIB_PRE_LOAD'     =>    'OT\\TagLib\\Article,OT\\TagLib\\Think,OT\\TagLib\\Amango',
        
    /* 主题设置 */
    'DEFAULT_THEME'       =>  'default',  // 默认模板主题名称 default

    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX'   => 'amango_', // 缓存前缀
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX'  => 'amango_home', //session前缀
    'COOKIE_PREFIX'   => 'amango_home_', // Cookie前缀 避免冲突
    'SHOW_PAGE_TRACE' => 0,
    /**
     * 附件相关配置
